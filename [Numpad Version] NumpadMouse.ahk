...
| (- / +)               | Description (axis)                 |
|-----------------------|------------------------------------|
| NumPadHome             | Left mouse button click.           |
| NumPadDiv           | Middle mouse button click.         |
| NumPadPgUp             | Right mouse button click.          |
| NumPadLeft/Right      | Horizontal mouse movement (X)      |
| NumPadClear/Up         | Vertical mouse movement (Y)        |
...
| NumPadPgUp             | Movement buttons lock (on/off).    |
|------------------------------------------------------------|
| NumPadEnter (pressed) | Activates functional modification  |
|-----------------------|------------------------------------|
| NumPadPgUp             | Sets the origin of the coordinate  |
...
| NumPadHome             | Moves to where equation is         |
|                        | currently.                         |
...
Hotkey, *NumPadSub, ButtonZUp
Hotkey, *NumPadAdd, ButtonZDown

Hotkey, *NumPadRight, ButtonXUp
Hotkey, *NumPadLeft, ButtonXDown
Hotkey, *NumPadUp, ButtonYUp
Hotkey, *NumPadClear, ButtonYDown
...
;Hotkey, NumPadEnter & NumPadClear,
Hotkey, NumPadEnter & NumPadPgDn, ButtonResetEquation
Hotkey, NumPadEnter & NumPadDiv, ButtonUseRelativeSystem
Hotkey, NumPadEnter & NumPadHome, ButtonToEquationCurrent
Hotkey, NumPadEnter & NumPadPgUp, ButtonCentralizeEquation
